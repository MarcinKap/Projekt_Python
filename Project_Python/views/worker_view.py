...
# from Project_Python.models import Worker
# from Project_Python.models import Position
# from my_project.Project_Python.models import Worker
from Project_Python.models import Worker, Position
...
class AvgWorkersView(LoginRequiredMixin, TemplateView):
    template_name = 'Project_Python/avg_workers.html'
    login_url = reverse_lazy('index')
